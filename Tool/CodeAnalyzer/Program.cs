...
namespace CodeAnalyzer
{
    class Program
    {
        ...
        private void GenerateMedusaCorePreDeclare()
        {
            ...
            {
                if (blockGroup.Key.Contains("Private") || blockGroup.Key.Contains("internal") || blockGroup.Key.Contains("Detail")) //ignore private classes
                {
                    continue;
                }
        ...
        static void Main(string[] args)
        {
            ...
            program.UpdatePaths(dir);


            program.GenerateMedusaCorePreDeclare();
            program.GenerateMedusaCoreHeader();

            program.GenerateMedusaPreDeclare();
            program.GenerateMedusaHeader();

            program.GenerateMedusaExtensionPreDeclare();
            program.GenerateMedusaExtensionHeader();
