...
{
    public class MedusaExtensionAndroidProjectGenerator
    {
        public const string ProjectName = "MedusaExtension";
        ...
        public static void Generate()
        {
            ...
            srcFiles.AddRange(GetSrcFiles(projectPath.CreateSubdirectory("Analytics")));
            srcFiles.AddRange(GetSrcFiles(projectPath.CreateSubdirectory("BusinessPlatform")));
        ...
        public static string GenerateSrcFiles(string text, List<FileInfo> srcFiles, DirectoryInfo projectPath, string dirPrefix)
        {
            ...
            //result.AppendLine(@"PaperCoreScript.cpp \");
