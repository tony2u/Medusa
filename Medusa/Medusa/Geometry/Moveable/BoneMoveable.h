...
public:
	...
	bool IsWorldFlipX()const { return MEDUSA_FLAG_HAS(mWorldFlip, FlipMask::X); }
	bool IsWorldFlipY()const { return MEDUSA_FLAG_HAS(mWorldFlip, FlipMask::Z); }
	bool IsWorldFlipZ()const { return MEDUSA_FLAG_HAS(mWorldFlip, FlipMask::Z); }
