...
namespace Siren
{
	...
	void Serialize(TWriter& writer, const Color4F& obj)
	{
		...
		writer.template OnField<float, false>(StringRef("R", 1), 0, obj.R);
		writer.template OnField<float, false>(StringRef("G", 1), 1, obj.G);
		writer.template OnField<float, false>(StringRef("B", 1), 2, obj.B);
		writer.template OnField<float, false>(StringRef("A", 1), 3, obj.A);
	...
	bool DeserializeTo(TReader& reader, Color4F& outObj)
	{
		...
		reader.template OnField<float, false>(StringRef("R", 1), 0, outObj.R);
		reader.template OnField<float, false>(StringRef("G", 1), 1, outObj.G);
		reader.template OnField<float, false>(StringRef("B", 1), 2, outObj.B);
		reader.template OnField<float, false>(StringRef("A", 1), 3, outObj.A);
	...
	{
		writer.OnStructBegin();
		writer.template OnField<byte, false>(StringRef("R", 1), 0, obj.R);
		writer.template OnField<byte, false>(StringRef("G", 1), 1, obj.G);
		writer.template OnField<byte, false>(StringRef("B", 1), 2, obj.B);
		writer.template OnField<byte, false>(StringRef("A", 1), 3, obj.A);
	...
	{
		reader.OnStructBegin();
		reader.template OnField<byte, false>(StringRef("R", 1), 0, outObj.R);
		reader.template OnField<byte, false>(StringRef("G", 1), 1, outObj.G);
		reader.template OnField<byte, false>(StringRef("B", 1), 2, outObj.B);
		reader.template OnField<byte, false>(StringRef("A", 1), 3, outObj.A);
...
template <>
struct LuaTypeMapping <Color4B>//[IGNORE_PRE_DECLARE]
{
	static void Push(lua_State* L, const Color4B& val)
	{
		LuaStack s(L);
		s.NewTable(0, 4);
		s.Rawset("R", val.R);
	...
	static Color4B Get(lua_State* L, int index)
	{
		Color4B result;
		LuaStack s(L);
		...
		result.A = s.Get<byte>("A", index);
		return result;
	}

	static Color4B Optional(lua_State* L, int index, const Color4B& def)
	{
		return lua_isnoneornil(L, index) ? Color4B::Black : Get(L, index);
	}

	static bool TryGet(lua_State* L, int index, Color4B& outValue)
	{
...
template <>
struct LuaTypeMapping <Color4F>//[IGNORE_PRE_DECLARE]
{
	static void Push(lua_State* L, const Color4F& val)
	{
		LuaStack s(L);
		s.NewTable(0, 4);
		s.Rawset("R", val.R);
	...
	static Color4F Get(lua_State* L, int index)
	{
		Color4F result;
		LuaStack s(L);
		...
		result.A = s.Get<float>("A", index);
		return result;
	}

	static Color4F Optional(lua_State* L, int index, const Color4F& def)
	{
		return lua_isnoneornil(L, index) ? Color4F::Black : Get(L, index);
	}

	static bool TryGet(lua_State* L, int index, Color4F& outValue)
	{
		RETURN_FALSE_IF(lua_isnoneornil(L, index));
		outValue = Get(L, index);
		return true;
