...
public:
	...
	virtual void LoadTexture(GraphicsTextureTarget textureTarget,int level, PixelType pixelType,const Size2U& size, int border,const void *pixels)const override;
	virtual void LoadSubTexture(GraphicsTextureTarget textureTarget,int level,const Rect2I& rect, PixelType pixelType, const void *pixels)const override;

	virtual void LoadCompressedTexture(GraphicsTextureTarget textureTarget,int level, PixelType pixelType, const Size2U& size, int border, uint imageSize, const void *pixels)const override;
	virtual void LoadCompressedSubTexture(GraphicsTextureTarget textureTarget,int level, PixelType pixelType, const Rect2I& rect,uint imageSize, const void *pixels)const override;
	virtual void CopyTexture(GraphicsTextureTarget textureTarget,int level, PixelType pixelType, const Rect2I& rect,int border)const override;
