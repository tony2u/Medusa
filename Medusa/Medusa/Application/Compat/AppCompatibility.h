...
{
	SIREN_FIELD(0, 0, Required, AppCompatibility, uint, mVersion);
	SIREN_FIELD(1, 1, Required, AppCompatibility, AppInitializeOperation, mOperation);
	SIREN_FIELDS_2(void,AppCompatibility);
};
