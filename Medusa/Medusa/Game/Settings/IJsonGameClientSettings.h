...
class IJsonGameClientSettings :public IGameClientSettings,public IJsonSettings
{
public:
	IJsonGameClientSettings(const FileIdRef& fileId);
	virtual ~IJsonGameClientSettings();
public:
	virtual void* GetAddress(const StringRef& name)const override;
public:
	...
	virtual StringRef UpdateServerConfigName()const override;
	virtual StringRef UpdateServerUrl()const override;
