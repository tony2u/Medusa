...
class LoadingBarReader : public INodeReader
{
	MEDUSA_RTTI(LoadingBarReader, INodeReader);
public:
	LoadingBarReader() {};
	virtual ~LoadingBarReader() {};
public:
	virtual INode* CreateNodeWithFlatBuffers(INodeEditor& editor, const flatbuffers::Table* loadingBarOptions, const StringRef& className = StringRef::Empty, NodeCreateFlags flags = NodeCreateFlags::None) override;
