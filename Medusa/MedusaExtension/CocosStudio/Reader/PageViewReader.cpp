...
INode* PageViewReader::CreateNodeWithFlatBuffers(INodeEditor& editor, const flatbuffers::Table* nodeTree, const StringRef& className /*= StringRef::Empty*/, NodeCreateFlags flags /*= NodeCreateFlags::None*/)
{
	auto options = (flatbuffers::PageViewOptions*)nodeTree;
	auto panel = (NodeFactory::Instance().CreatePanel(PanelType::Dock));
	...
	break;
	default:
		Log::AssertFailed("PageViewReader PanelBackGroundColorType  Error");
		break;
	}
...
INode* PageViewReader::CreateNodeWithJson(INodeEditor& editor, const rapidjson::Value& nodeTree, const StringRef& className /*= StringRef::Empty*/, NodeCreateFlags flags /*= NodeCreateFlags::None*/)
{
	return nullptr;
}
