...
public:
	...
	FileCodeWriteStream(const FileCodeWriteStream&) = delete;
	FileCodeWriteStream& operator=(const FileCodeWriteStream&) = delete;
	FileCodeWriteStream(FileCodeWriteStream&& other);
	FileCodeWriteStream& operator=(FileCodeWriteStream&& other);
public:
