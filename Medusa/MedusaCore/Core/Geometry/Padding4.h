...
namespace Siren
{
	...
	void Serialize(TWriter& writer, const Padding4<T>& obj)
	{
		...
		writer.template OnProperty<T, false>("Left", 4, 0, obj.Left);
		writer.template OnProperty<T, false>("Right", 5, 1, obj.Right);
		writer.template OnProperty<T, false>("Up", 2, 2, obj.Up);
		writer.template OnProperty<T, false>("Down", 4, 3, obj.Down);
	...
	bool DeserializeTo(TReader& reader, Padding4<T>& outObj)
	{
		...
		reader.template OnProperty<T, false>("Left", 4, 0, outObj.Left);
		reader.template OnProperty<T, false>("Right", 5, 1, outObj.Right);
		reader.template OnProperty<T, false>("Up", 2, 2, outObj.Up);
		reader.template OnProperty<T, false>("Down", 4, 3, outObj.Down);
