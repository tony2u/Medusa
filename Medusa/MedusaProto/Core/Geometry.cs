...
{
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Point2")]
    ...
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Size2")]
    ...
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Scale2")]
    ...
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Range")]
    ...
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Rect2")]
    ...
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Padding4")]
    ...
    [SirenClass(typeof(MedusaCoreTemplate), @"Core/Geometry", SirenGenerateMode.Suppress, NewHeader = "Color4")]
