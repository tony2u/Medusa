...
bool ParallaxScrollComponentLayer::Initialize()
{
	...
	{
		Sprite* child = NodeFactory::Instance().CreateQuadSprite(FileIdRef("Background.png", i));
	...
	Sprite* mainSprite = NodeFactory::Instance().CreateQuadSprite("test2.png");
...
MEDUSA_IMPLEMENT_LAYER(ParallaxScrollComponentLayer, BaseCaseLayer, StringRef::Empty);
