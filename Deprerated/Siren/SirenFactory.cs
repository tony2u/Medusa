...
namespace Siren
{
    public static class SirenFactory
    {
        ...
        public static SirenFieldType GetPropertyType(Type type)
        {
            if (type.IsGenericType)
            {
                if (type.Name.StartsWith("List"))
                {
                    return SirenFieldType.List;
                }
                if (type.Name.StartsWith("Dictionary"))
                {
                    return SirenFieldType.Dictionary;
                }
            }
            else
            {
                if (type.IsValueType)
                {
                    ...
                    {
                        return SirenFieldType.String;
                    }
                    if (type == typeof(byte[]))
                    {
                        return SirenFieldType.Blob;
                    }

                    if (type == typeof(bool))
                    {
                        return SirenFieldType.Bool;
                    }
                    if (type == typeof(char))
                    {
                        return SirenFieldType.Int8;
                    }
                    if (type == typeof(short))
                    {
                        return SirenFieldType.Int16;
                    }
                    if (type == typeof(int))
                    {
                        return SirenFieldType.Int32;
                    }
                    if (type == typeof(Int64))
                    {
                        return SirenFieldType.Int64;
                    }
                    if (type == typeof(byte))
                    {
                        return SirenFieldType.UInt8;
                    }
                    if (type == typeof(ushort))
                    {
                        return SirenFieldType.UInt16;
                    }
                    if (type == typeof(uint))
                    {
                        return SirenFieldType.UInt32;
                    }
                    if (type == typeof(UInt64))
                    {
                        return SirenFieldType.UInt64;
                    }
                    if (type == typeof(float))
                    {
                        return SirenFieldType.Float;
                    }
                    if (type == typeof(double))
                    {
                        return SirenFieldType.Double;
                    }

                }

            }
            return SirenFieldType.Struct;
